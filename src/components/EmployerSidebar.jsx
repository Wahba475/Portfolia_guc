...
export default function EmployerSidebar({ currentUser, onLogout, onClose, notifications = [], onMarkRead }) {
  const location = useLocation()
  const navigate = useNavigate()

  const navItems = [
    { to: '/employer/dashboard',   label: 'Dashboard',   icon: LayoutDashboard },
    { to: '/employer/internships', label: 'Internships',  icon: Briefcase },
    { to: '/employer/portfolios',  label: 'Portfolios',   icon: Users },
